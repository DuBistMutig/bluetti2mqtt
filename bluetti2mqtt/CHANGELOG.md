...
- Update base python image to 17.0.0 for Home Assistant 16.3 (fixes [#69](https://github.com/SSMCD/bluetti2mqtt/issues/69)).
- Switch to bluetti_mqtt fork by [ftrueck](https://github.com/ftrueck).
- Fix regex to support longer serial numbers (fixes [#60](https://github.com/SSMCD/bluetti2mqtt/issues/60)).
- Update bluez package to latest version.
